            ...
            <div className="flex flex-col sm:flex-row items-center justify-between px-4 py-3 border-t-2 border-slate-200 bg-gradient-to-r from-slate-50 to-blue-50 gap-3">
              ...
              <div className="flex items-center gap-2">
                <button 
                  ...
                  className="p-2.5 rounded-lg transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-white active:bg-slate-100 bg-white/80 border-2 border-slate-200 hover:border-blue-300 disabled:hover:border-slate-200 shadow-sm hover:shadow-md transform hover:scale-105 active:scale-95 disabled:transform-none" 
